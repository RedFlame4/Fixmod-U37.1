Hooks:PostHook(GroupAITweakData, "_init_unit_categories", "promod_init_unit_categories", function(self, difficulty_index)
	...
	-- Unit category fixes
	self.unit_categories.CS_cop_C45_R870.units = {
		Idstring("units/payday2/characters/ene_cop_1/ene_cop_1"),
		Idstring("units/payday2/characters/ene_cop_2/ene_cop_2"),
		Idstring("units/payday2/characters/ene_cop_4/ene_cop_4")
	}
	self.unit_categories.CS_cop_stealth_MP5.units = {
	...
	if difficulty_index >= 6 then
		self.unit_categories.FBI_swat_M4.units = {
		...
		self.unit_categories.FBI_swat_R870.units = {
			Idstring("units/payday2/characters/ene_city_swat_2/ene_city_swat_2") -- benelli
		}
	end

	self.unit_categories.CS_heavy_M4_w.units = self.unit_categories.CS_heavy_M4.units -- ensure it's always consistent with acrobatic
	self.unit_categories.FBI_heavy_G36_w.units = self.unit_categories.FBI_heavy_G36.units -- ensure it's always consistent with acrobatic
end)
